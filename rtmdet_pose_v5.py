...
model = dict(
    ...
    pose_head=dict(
        type='HeatmapHeadV5', num_keypoints=7, in_channels=96, feat_channels=128,
        upsample_factor=2,
        sigma=3.0,
        match_iou_thr=0.1,
        log_stats=True,
        ...
        fg_weight=10.0,
        occluded_weight=0.3,
        # V5 soft-argmax coord loss params
        coord_loss_weight=0.5,    # SmoothL1 coordinate loss weight (lower to avoid conflict with heatmap MSE)
